#!/usr/bin/env sh
# Universal installer for redpath. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/redpath.git"
echo "Installing redpath ..."
